...
exports.createUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userRepository, name, username, email, getUser, newUser;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                getUser = _a.sent();
                if (!(getUser.length > 0)) return [3 /*break*/, 2];
                req.body.message = "Email already exists";
                res.status(409).send(req.body);
                return [3 /*break*/, 4];
            case 2:
                newUser = new User_1.User(req.body.name, req.body.username, req.body.email);
...
exports.getUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userRepository, name, username, email, newUser;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                userRepository = typeorm_1.getMongoRepository(User_1.User);
